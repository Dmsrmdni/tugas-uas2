                                ...
                                <input type="hidden" name="id" value="<?= $id; ?>">
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kode_pendaftaran" name="kode_pendaftaran"  value="<?= $kode_pendaftaran; ?>"  required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="agama" name="agama" value="<?= $agama; ?>" required>
                                                <option selected hidden>Agama</option>
