        ...
        <div class="content">
            ...
            <div class="row">
                <div class="card w-50 mx-auto">
                    ...
                    ?>
                      <?php  foreach ($pembayaran->edit($_GET['id']) as $data) :
                            $id = $data['id'];
                            ...
                            <form action="../pembayaran/proses.php" method="POST" class="d-flex p-4">
                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kode_pembayaran" name="kode_pembayaran"  value="<?= $kode_pembayaran ?>"  required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_pembayaran" name="tanggal_pembayaran"  value="<?= $tanggal_pembayaran ?>" required>
                                    </div>

                                    <div class="mb-3">
                                            <label for="uang_pendaftaran" class="form-label">uang pendaftaran</label>
                                            <input type="number" class="form-control" id="uang_pendaftaran" name="uang_pendaftaran"  value="<?= $uang_pendaftaran ?>"  required>
                                    </div>

                                    <div class="mb-3">
                                            <label for="uang_seragam" class="form-label">uang seragam</label>
                                            <input type="number" class="form-control" id="uang_seragam" name="uang_seragam"  value="<?= $uang_seragam ?>"  required>
                                    </div>

                                    <div class="mb-3">
                                            <label for="uang_kegiatan" class="form-label">uang kegiatan</label>
                                            <input type="number" class="form-control" id="uang_kegiatan" name="uang_kegiatan"  value="<?= $uang_kegiatan ?>"  required>
                                    </div> 
