            ...
            <div class="row">
                <div class="card w-50 mx-auto">
                    ...
                    <form action="../pembayaran/proses.php" method="POST" class="d-flex p-4">
                        ...
                        <div class="col">
                                <h3 class="mx-auto">Tambah Data</h3>
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kode_pembayaran" name="kode_pembayaran"  placeholder="Kode Pembayaran"  required>
                            </div>

                            <div class="form-group">
                                <label for="id_pendaftaran">Nama</label>
                                <select name ="id_pendaftaran" class="form-control" id="id_pendaftaran">
                                <?php
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_pembayaran" name="tanggal_pembayaran"  placeholder="Tanggal Pembayaran"  required>
                            </div>

                            <div class="mb-3">
                                    <label for="uang_pendaftaran" class="form-label">uang pendaftaran</label>
                                    <input type="number" class="form-control" id="uang_pendaftaran" name="uang_pendaftaran"  placeholder="uang pendaftaran"  required>
                            </div>

                            <div class="mb-3">
                                    <label for="uang_seragam" class="form-label">uang seragam</label>
                                    <input type="number" class="form-control" id="uang_seragam" name="uang_seragam"  placeholder="uang seragam"  required>
                            </div>

                            <div class="mb-3">
                                    <label for="uang_kegiatan" class="form-label">uang kegiatan</label>
                                    <input type="number" class="form-control" id="uang_kegiatan" name="uang_kegiatan"  placeholder="uang kegiatan"  required>
                            </div> 
